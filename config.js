...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "SHABAN-SOBX-MD~HZVDjDwa#B4SVZUtkUyFh47U52sSNIRB-LSofy0G5t1nm_brR5Cw",
// add your Session Id 
...
BOT_NAME: process.env.BOT_NAME || "CK CineMAX",
// add bot namw here for menu
STICKER_NAME: process.env.STICKER_NAME || "CK CineMAX",
...
OWNER_NAME: process.env.OWNER_NAME || "Chethmina Kavishan",
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "CK CineMAX",
// add bot owner name    
ALIVE_IMG: process.env.ALIVE_IMG || "https://i.ibb.co/9N1sJ41/Manul-Ofc-X.jpg",
// add img for alive msg
LIVE_MSG: process.env.LIVE_MSG || "CK CineMAX",
// add alive msg here 
